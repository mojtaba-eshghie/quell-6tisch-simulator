...
#        #maximize interference effects in order to check.log ideal cases
#        if broadcast==False:
...
#                    return -10.0
    ...
    def _computePdrFromSINR(self, sinr, destination):
	 ...
	 #for remove propagation errors in order to check.log ideal cases (if it is in range, PDR=1)
#        if sinr > 10:
#            return 1
#        else:
#            return 0
